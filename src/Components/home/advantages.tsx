  ...
  return (
    <section className={styles.advantages}>
      ...
      <div className={styles.advantages_text}>
        ...
        <p>
          Болле 5 лет на передовой логистики. Доставили более 200 грузов,
          создавая надежные связи и обеспечивая эффективность в каждой доставке.
          Ваш выбор для успешных перевозок.
        </p>
